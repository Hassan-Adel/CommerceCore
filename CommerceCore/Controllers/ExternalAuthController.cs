...
namespace CommerceCore.Controllers
{
    ...
    public class ExternalAuthController : Controller
    {
        ...
        public ExternalAuthController(IOptions<FacebookAuthSettings> fbAuthSettingsAccessor, UserManager<AppUser> userManager, UserDBContext appDbContext, IJwtFactory jwtFactory, IOptions<JwtIssuerOptions> jwtOptions)
        {
